...
Finally, the user can begin the ride for a previously chosen timeframe
...
These are all of the functional requirements. A UML use case diagram is used
...
in future years. Thus, the non-functional requirement is that the system
