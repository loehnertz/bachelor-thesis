...
user-friendliness and so forth~\cite{swebok}.
...
applied to actually gather them.\\
...
a minimal viable product (MVP) sooner than later during the development process.

\paragraph{Modeling}
After the requirements are classified, they can be modeled into e.g. a diagram.
...
Here goes the design description.


\subsection{Implementation}

Here goes the implementation description.
