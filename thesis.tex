...
\subsubsection{Service structure}
...
are generated to initialize the defined \code{Messages} and to create and consume
the \textit{Go Micro} services stated in each \code{.proto} file.

\begin{lstlisting}[title=services/fleet-monitor/proto/fleet-monitor.micro.go]
func RegisterFleetMonitorHandler(
  s server.Server,
  hdlr FleetMonitorHandler,
...
For instance, this function is generated to register the newly defined service.
...
The argument \code{new(FleetMonitor)} is explained shortly.
