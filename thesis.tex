...
\subsection{Requirements} \label{subsect:hypothetical-requirements}
...
function is getting type-checked. Thus, a function cannot produce an error
based on a erroneous input type. For instance, if a function expects a string
as its input, it cannot be called with a number.
