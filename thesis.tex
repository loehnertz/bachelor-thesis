...
The main aspect of success for such a system is indeed the \textit{magic} behind the scenes
...
Moreover, these explanations do not consider the difference in development utilizing
an incremental approach opposed to a sequential one; the point of view is generalized.
\newpage
...
differently than a distinct but small feature. Similarly, the stakeholders should
...
a minimal viable product (MVP) sooner than later during
...
mentions seven of them~\cite{swebok}: abstraction, coupling and cohesion,
decomposition and modularization, information hiding, separation of interface
and implementation, sufficiency and completeness, and separation of concerns.
...
since high coupling lowers the abstraction of a system and vice versa.
...
a distinct task while having concrete interfaces to interact with each other.
...
There are two general types of notations regarding software architectures.
The simpler one are the \textit{block diagrams}; they portray the components of
