...
In the end, there are two options: a complete replacement of the legacy solution
or a partial augmentation of it~\cite{bennett-coping-legacy, seacord-modernizing-legacy}.


\subsection{Problems with legacy software}

\subsection{Reasons to continue legacy software}

\subsection{Techniques to augment legacy software}
