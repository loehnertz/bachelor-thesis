...
Finally, a \textit{Circuit Breaker} should be used to prevent large-scale failures.
...
Consequently, this can lead to a cascade of breakdowns of services that wait for
...
while the one where the \textit{Circuit Breaker} tripped will not break down itself~\cn.\\
...
The fundamentals of the software design are determined by answering the five
